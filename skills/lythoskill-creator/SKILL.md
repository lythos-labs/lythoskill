...
```bash
bunx @lythos/skill-creator@0.9.50 add-skill <skill-name>
```
...
bunx @lythos/skill-creator@0.9.50 align

# Auto-fix drift where possible
bunx @lythos/skill-creator@0.9.50 align --fix
```
...
```bash
# Semver targets
bunx @lythos/skill-creator@0.9.50 bump patch
bunx @lythos/skill-creator@0.9.50 bump minor
bunx @lythos/skill-creator@0.9.50 bump major

# Explicit version (e.g. for major milestones)
bunx @lythos/skill-creator@0.9.50 bump 1.0.0
