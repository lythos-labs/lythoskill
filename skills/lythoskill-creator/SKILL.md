...
```bash
bunx @lythos/skill-creator@0.9.41 add-skill <skill-name>
```
...
bunx @lythos/skill-creator@0.9.41 align

# Auto-fix drift where possible
bunx @lythos/skill-creator@0.9.41 align --fix
```
...
```bash
# Semver targets
bunx @lythos/skill-creator@0.9.41 bump patch
bunx @lythos/skill-creator@0.9.41 bump minor
bunx @lythos/skill-creator@0.9.41 bump major

# Explicit version (e.g. for major milestones)
bunx @lythos/skill-creator@0.9.41 bump 1.0.0
