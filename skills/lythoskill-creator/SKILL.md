...
```bash
bunx @lythos/skill-creator@0.15.4 add-skill <skill-name>
```
...
```bash
# Semver targets
bunx @lythos/skill-creator@0.15.4 bump patch
bunx @lythos/skill-creator@0.15.4 bump minor
bunx @lythos/skill-creator@0.15.4 bump major

# Explicit version (e.g. for major milestones)
bunx @lythos/skill-creator@0.15.4 bump 1.0.0
