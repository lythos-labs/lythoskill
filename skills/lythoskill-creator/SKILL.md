...
bunx @lythos/skill-creator@0.14.4 align

# Auto-fix drift where possible
bunx @lythos/skill-creator@0.14.4 align --fix
```
...
```bash
# Semver targets
bunx @lythos/skill-creator@0.14.4 bump patch
bunx @lythos/skill-creator@0.14.4 bump minor
bunx @lythos/skill-creator@0.14.4 bump major

# Explicit version (e.g. for major milestones)
bunx @lythos/skill-creator@0.14.4 bump 1.0.0
