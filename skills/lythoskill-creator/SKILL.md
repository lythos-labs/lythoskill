...
```bash
bunx @lythos/skill-creator@0.9.42 add-skill <skill-name>
```
...
bunx @lythos/skill-creator@0.9.42 align

# Auto-fix drift where possible
bunx @lythos/skill-creator@0.9.42 align --fix
```
...
```bash
# Semver targets
bunx @lythos/skill-creator@0.9.42 bump patch
bunx @lythos/skill-creator@0.9.42 bump minor
bunx @lythos/skill-creator@0.9.42 bump major

# Explicit version (e.g. for major milestones)
bunx @lythos/skill-creator@0.9.42 bump 1.0.0
