...
```bash
bunx @lythos/skill-creator@0.14.5 add-skill <skill-name>
```
...
bunx @lythos/skill-creator@0.14.5 align

# Auto-fix drift where possible
bunx @lythos/skill-creator@0.14.5 align --fix
```
...
```bash
# Semver targets
bunx @lythos/skill-creator@0.14.5 bump patch
bunx @lythos/skill-creator@0.14.5 bump minor
bunx @lythos/skill-creator@0.14.5 bump major

# Explicit version (e.g. for major milestones)
bunx @lythos/skill-creator@0.14.5 bump 1.0.0
