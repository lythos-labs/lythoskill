...
```bash
bunx @lythos/skill-creator@0.11.2 add-skill <skill-name>
```
...
bunx @lythos/skill-creator@0.11.2 align

# Auto-fix drift where possible
bunx @lythos/skill-creator@0.11.2 align --fix
```
...
```bash
# Semver targets
bunx @lythos/skill-creator@0.11.2 bump patch
bunx @lythos/skill-creator@0.11.2 bump minor
bunx @lythos/skill-creator@0.11.2 bump major

# Explicit version (e.g. for major milestones)
bunx @lythos/skill-creator@0.11.2 bump 1.0.0
