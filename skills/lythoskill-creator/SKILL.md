...
```bash
bunx @lythos/skill-creator@0.9.40 add-skill <skill-name>
```
...
```bash
# Semver targets
bunx @lythos/skill-creator@0.9.40 bump patch
bunx @lythos/skill-creator@0.9.40 bump minor
bunx @lythos/skill-creator@0.9.40 bump major

# Explicit version (e.g. for major milestones)
bunx @lythos/skill-creator@0.9.40 bump 1.0.0
