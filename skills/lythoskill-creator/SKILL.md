...
```bash
bunx @lythos/skill-creator@0.15.7 add-skill <skill-name>
```
...
bunx @lythos/skill-creator@0.15.7 align

# Auto-fix drift where possible
bunx @lythos/skill-creator@0.15.7 align --fix
```
...
```bash
# Semver targets
bunx @lythos/skill-creator@0.15.7 bump patch
bunx @lythos/skill-creator@0.15.7 bump minor
bunx @lythos/skill-creator@0.15.7 bump major

# Explicit version (e.g. for major milestones)
bunx @lythos/skill-creator@0.15.7 bump 1.0.0
