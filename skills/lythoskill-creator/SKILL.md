...
```bash
bunx @lythos/skill-creator@0.17.2 init <project-name>
```
...
```bash
bunx @lythos/skill-creator@0.17.2 add-skill <skill-name>
```
...
```bash
bunx @lythos/skill-creator@0.17.2 build --all
```
...
bunx @lythos/skill-creator@0.17.2 align

# Auto-fix drift where possible
bunx @lythos/skill-creator@0.17.2 align --fix
```
...
```bash
# Semver targets
bunx @lythos/skill-creator@0.17.2 bump patch
bunx @lythos/skill-creator@0.17.2 bump minor
bunx @lythos/skill-creator@0.17.2 bump major

# Explicit version (e.g. for major milestones)
bunx @lythos/skill-creator@0.17.2 bump 1.0.0

# Preview the bump without writing files
bunx @lythos/skill-creator@0.17.2 bump 1.0.0 --dry-run
```
