...
```bash
bunx @lythos/skill-creator@0.9.37 add-skill <skill-name>
```
...
bunx @lythos/skill-creator@0.9.37 align

# Auto-fix drift where possible
bunx @lythos/skill-creator@0.9.37 align --fix
```
...
```bash
# Semver targets
bunx @lythos/skill-creator@0.9.37 bump patch
bunx @lythos/skill-creator@0.9.37 bump minor
bunx @lythos/skill-creator@0.9.37 bump major

# Explicit version (e.g. for major milestones)
bunx @lythos/skill-creator@0.9.37 bump 1.0.0
