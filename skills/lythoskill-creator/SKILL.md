...
```bash
bunx @lythos/skill-creator@0.10.1 add-skill <skill-name>
```
...
bunx @lythos/skill-creator@0.10.1 align

# Auto-fix drift where possible
bunx @lythos/skill-creator@0.10.1 align --fix
```
...
```bash
# Semver targets
bunx @lythos/skill-creator@0.10.1 bump patch
bunx @lythos/skill-creator@0.10.1 bump minor
bunx @lythos/skill-creator@0.10.1 bump major

# Explicit version (e.g. for major milestones)
bunx @lythos/skill-creator@0.10.1 bump 1.0.0
