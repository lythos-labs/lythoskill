...
```bash
bunx @lythos/skill-creator@0.9.39 add-skill <skill-name>
```
...
```bash
# Semver targets
bunx @lythos/skill-creator@0.9.39 bump patch
bunx @lythos/skill-creator@0.9.39 bump minor
bunx @lythos/skill-creator@0.9.39 bump major

# Explicit version (e.g. for major milestones)
bunx @lythos/skill-creator@0.9.39 bump 1.0.0
