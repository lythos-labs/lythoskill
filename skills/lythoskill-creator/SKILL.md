...
```bash
bunx @lythos/skill-creator@0.15.3 add-skill <skill-name>
```
...
bunx @lythos/skill-creator@0.15.3 align

# Auto-fix drift where possible
bunx @lythos/skill-creator@0.15.3 align --fix
```
...
```bash
# Semver targets
bunx @lythos/skill-creator@0.15.3 bump patch
bunx @lythos/skill-creator@0.15.3 bump minor
bunx @lythos/skill-creator@0.15.3 bump major

# Explicit version (e.g. for major milestones)
bunx @lythos/skill-creator@0.15.3 bump 1.0.0
