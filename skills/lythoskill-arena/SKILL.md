...
allowed-tools:
  - Bash(bunx @lythos/skill-arena@0.11.1 *)
  - Bash(bunx @lythos/skill-deck@0.11.1 link *)
...
```bash
bunx @lythos/skill-arena@0.11.1 run --config ./arena.toml
bunx @lythos/skill-arena@0.11.1 run --config ./arena.toml --dry-run
```
...
```bash
bunx @lythos/skill-arena@0.11.1 scaffold \
...
```bash
bunx @lythos/skill-arena@0.11.1 viz tmp/arena-<id>/
```
