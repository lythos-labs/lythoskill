...
allowed-tools:
  - Bash(bunx @lythos/skill-arena@0.9.41 *)
  - Bash(bunx @lythos/skill-deck@0.9.41 link *)
...
bunx @lythos/skill-arena@0.9.41 agent-run \
  --task ./TASK.md \
...
```bash
bunx @lythos/skill-arena@0.9.41 run --config ./arena.toml
bunx @lythos/skill-arena@0.9.41 run --config ./arena.toml --dry-run
```
...
```bash
bunx @lythos/skill-arena@0.9.41 scaffold \
