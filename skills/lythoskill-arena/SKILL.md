...
allowed-tools:
  - Bash(bunx @lythos/skill-arena@0.12.0 *)
  - Bash(bunx @lythos/skill-deck@0.12.0 link *)
...
```bash
bunx @lythos/skill-arena@0.12.0 run --config ./arena.toml
bunx @lythos/skill-arena@0.12.0 run --config ./arena.toml --dry-run
```
...
```bash
bunx @lythos/skill-arena@0.12.0 scaffold \
...
```bash
bunx @lythos/skill-arena@0.12.0 viz tmp/arena-<id>/
```
