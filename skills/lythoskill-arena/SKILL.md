...
allowed-tools:
  - Bash(bunx @lythos/skill-arena@0.9.43 *)
  - Bash(bunx @lythos/skill-deck@0.9.43 link *)
...
```bash
bunx @lythos/skill-arena@0.9.43 run --config ./arena.toml
bunx @lythos/skill-arena@0.9.43 run --config ./arena.toml --dry-run
```
...
```bash
bunx @lythos/skill-arena@0.9.43 scaffold \
...
```bash
bunx @lythos/skill-arena@0.9.43 viz tmp/arena-<id>/
```
