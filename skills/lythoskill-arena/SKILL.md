...
allowed-tools:
  - Bash(bunx @lythos/skill-arena@0.9.47 *)
  - Bash(bunx @lythos/skill-deck@0.9.47 link *)
...
bunx @lythos/skill-arena@0.9.47 single \
...
```bash
bunx @lythos/skill-arena@0.9.47 run --config ./arena.toml
bunx @lythos/skill-arena@0.9.47 run --config ./arena.toml --dry-run
```
...
```bash
bunx @lythos/skill-arena@0.9.47 vs --config ./arena.toml
bunx @lythos/skill-arena@0.9.47 vs --config ./arena.toml --dry-run
```
...
```bash
bunx @lythos/skill-arena@0.9.47 scaffold \
...
```bash
bunx @lythos/skill-arena@0.9.47 viz tmp/arena-<id>/
```
