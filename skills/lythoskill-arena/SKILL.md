...
allowed-tools:
  - Bash(bunx @lythos/skill-arena@0.9.42 *)
  - Bash(bunx @lythos/skill-deck@0.9.42 link *)
...
```bash
bunx @lythos/skill-arena@0.9.42 run --config ./arena.toml
bunx @lythos/skill-arena@0.9.42 run --config ./arena.toml --dry-run
```
...
```bash
bunx @lythos/skill-arena@0.9.42 scaffold \
...
```bash
bunx @lythos/skill-arena@0.9.42 viz tmp/arena-<id>/
```
