...
allowed-tools:
  - Bash(bunx @lythos/skill-arena@0.14.5 *)
  - Bash(bunx @lythos/skill-deck@0.14.5 link *)
...
1. **Prepare** — `prepare-workdir` with minimal deck
   ```bash
   bunx @lythos/skill-arena@0.14.5 prepare-workdir \
     --deck ./test-deck.toml \
...
```bash
# Plan-first
bunx @lythos/skill-arena@0.14.5 archive \
