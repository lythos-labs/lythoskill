...
allowed-tools:
  - Bash(bunx @lythos/skill-arena@0.11.2 *)
  - Bash(bunx @lythos/skill-deck@0.11.2 link *)
...
```bash
bunx @lythos/skill-arena@0.11.2 run --config ./arena.toml
bunx @lythos/skill-arena@0.11.2 run --config ./arena.toml --dry-run
```
...
```bash
bunx @lythos/skill-arena@0.11.2 scaffold \
...
```bash
bunx @lythos/skill-arena@0.11.2 viz tmp/arena-<id>/
```
