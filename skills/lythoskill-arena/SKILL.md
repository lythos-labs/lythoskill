...
allowed-tools:
  - Bash(bunx @lythos/skill-arena@0.14.2 *)
  - Bash(bunx @lythos/skill-deck@0.14.2 link *)
...
```bash
# Plan-first
bunx @lythos/skill-arena@0.14.2 archive \
