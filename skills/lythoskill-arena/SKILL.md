...
allowed-tools:
  - Bash(bunx @lythos/skill-arena@0.9.46 *)
  - Bash(bunx @lythos/skill-deck@0.9.46 link *)
...
bunx @lythos/skill-arena@0.9.46 single \
...
```bash
bunx @lythos/skill-arena@0.9.46 run --config ./arena.toml
bunx @lythos/skill-arena@0.9.46 run --config ./arena.toml --dry-run
```
...
```bash
bunx @lythos/skill-arena@0.9.46 vs --config ./arena.toml
bunx @lythos/skill-arena@0.9.46 vs --config ./arena.toml --dry-run
```
...
```bash
bunx @lythos/skill-arena@0.9.46 scaffold \
...
```bash
bunx @lythos/skill-arena@0.9.46 viz tmp/arena-<id>/
```
