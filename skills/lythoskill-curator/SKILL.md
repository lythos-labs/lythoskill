...
bunx @lythos/skill-curator@0.14.3 tag <skill-name> --niche "meta.governance.deck"
bunx @lythos/skill-curator@0.14.3 tag <skill-name> --niche "code-review" --niche "security"

# Write QA signal with provenance (REQUIRED)
bunx @lythos/skill-curator@0.14.3 tag <skill-name> \
...
bunx @lythos/skill-curator@0.14.3 query   # show schema overview
```
...
bunx @lythos/skill-curator@0.14.3 query "SELECT name, niches FROM skills WHERE niches LIKE '%agent-tagged%'"
# Duplicate detection
