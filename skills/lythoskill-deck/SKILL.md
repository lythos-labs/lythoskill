...
allowed-tools:
  - Bash(bunx @lythos/skill-deck@0.17.2 *)
...
bunx @lythos/skill-deck@0.17.2 link
bunx @lythos/skill-deck@0.17.2 link --deck ./phase1-brand.toml

# Add skill from cold pool or download URL
bunx @lythos/skill-deck@0.17.2 add github.com/owner/repo/skill-name
bunx @lythos/skill-deck@0.17.2 add github.com/owner/repo/skill-name --alias my-skill --type tool
...
bunx @lythos/skill-deck@0.17.2 validate --remote          # probe locators against GitHub
...
bunx @lythos/skill-deck@0.17.2 to-symlink <alias>   # snapshot → symlink
bunx @lythos/skill-deck@0.17.2 to-snapshot <alias>  # symlink → snapshot (pin HEAD)
bunx @lythos/skill-deck@0.17.2 reconcile            # drift report vs cold pool
bunx @lythos/skill-deck@0.17.2 reconcile --apply    # converge
...
⚠️  This deck uses the deprecated string-array format. Run migrate?
   bunx @lythos/skill-deck@0.17.2 migrate-schema
   bunx @lythos/skill-deck@0.17.2 migrate-schema --dry-run  # preview first
```
...
bunx @lythos/skill-deck@0.17.2 add github.com/owner/repo/skill
```
