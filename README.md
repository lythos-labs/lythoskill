...
bunx @lythos/skill-deck@0.9.17 add <owner>/<repo>
...
bunx @lythos/skill-deck@0.9.17 add github.com/owner/repo/skills/my-skill
...
2. Run `bunx @lythos/skill-deck@0.9.17 add <owner>/<repo>` to add a skill
3. Run `bunx @lythos/skill-deck@0.9.17 link` to sync the working set
...
bunx @lythos/skill-creator@0.9.17 init my-skill
cd my-skill
...
bunx @lythos/skill-creator@0.9.17 build my-skill
```
...
2. Creates a task via `bunx @lythos/project-cortex@0.9.17 task "Build Todo List page"`
...
bunx @lythos/skill-deck@0.9.17 link                       # Sync toml -> working set
bunx @lythos/skill-deck@0.9.17 add owner/repo             # Download skill + add to deck
bunx @lythos/skill-deck@0.9.17 link --deck ./my-deck.toml
...
# Project governance
bunx @lythos/project-cortex@0.9.17 task "Fix auth flow"
