...
bunx @lythos/skill-deck@0.9.18 add <owner>/<repo>
...
bunx @lythos/skill-deck@0.9.18 add github.com/owner/repo/skills/my-skill
...
2. Run `bunx @lythos/skill-deck@0.9.18 add <owner>/<repo>` to add a skill
3. Run `bunx @lythos/skill-deck@0.9.18 link` to sync the working set
...
bunx @lythos/skill-creator@0.9.18 init my-skill
cd my-skill
...
bunx @lythos/skill-creator@0.9.18 build my-skill
```
...
2. Creates a task via `bunx @lythos/project-cortex@0.9.18 task "Build Todo List page"`
...
bunx @lythos/skill-deck@0.9.18 link                       # Sync toml -> working set
bunx @lythos/skill-deck@0.9.18 add owner/repo             # Download skill + add to deck
bunx @lythos/skill-deck@0.9.18 link --deck ./my-deck.toml
...
# Project governance
bunx @lythos/project-cortex@0.9.18 task "Fix auth flow"
