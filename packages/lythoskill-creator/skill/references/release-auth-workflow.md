...
```bash
# Preview
bunx @lythos/skill-creator@{{PACKAGE_VERSION}} bump patch --dry-run
bunx @lythos/skill-creator@{{PACKAGE_VERSION}} bump 1.0.0 --dry-run

# Real run
bunx @lythos/skill-creator@{{PACKAGE_VERSION}} bump patch       # 0.7.2 → 0.7.3
bunx @lythos/skill-creator@{{PACKAGE_VERSION}} bump minor       # 0.7.2 → 0.8.0
bunx @lythos/skill-creator@{{PACKAGE_VERSION}} bump major       # 0.7.2 → 1.0.0
bunx @lythos/skill-creator@{{PACKAGE_VERSION}} bump 1.2.3       # explicit X.Y.Z
```
