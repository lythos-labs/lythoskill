...
# or use directly
bunx @lythos/skill-creator@0.14.3 <command>
```
...
bunx @lythos/skill-creator@0.14.3 init my-project

# Add a new skill to an existing monorepo
cd my-project
bunx @lythos/skill-creator@0.14.3 add-skill my-new-skill

# Build a skill (copies skill/ to skills/ with template substitution)
bunx @lythos/skill-creator@0.14.3 build my-new-skill
...
```
Starter (this package) → npm publish → bunx @lythos/skill-creator@0.14.3 ...
