...
# or use directly
bunx @lythos/skill-creator@0.9.24 <command>
```
...
cd my-project
bunx @lythos/skill-creator@0.9.24 add-skill my-new-skill

# Build a skill (copies skill/ to skills/ with template substitution)
bunx @lythos/skill-creator@0.9.24 build my-new-skill

# Audit an existing project against current conventions
bunx @lythos/skill-creator@0.9.24 align
# Auto-fix drift where possible
bunx @lythos/skill-creator@0.9.24 align --fix
```
...
```
Starter (this package) → npm publish → bunx @lythos/skill-creator@0.9.24 ...
