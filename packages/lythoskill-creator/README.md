...
# or use directly
bunx @lythos/skill-creator@0.9.30 <command>
```
...
bunx @lythos/skill-creator@0.9.30 init my-project

# Add a new skill to an existing monorepo
cd my-project
bunx @lythos/skill-creator@0.9.30 add-skill my-new-skill

# Build a skill (copies skill/ to skills/ with template substitution)
bunx @lythos/skill-creator@0.9.30 build my-new-skill

# Audit an existing project against current conventions
bunx @lythos/skill-creator@0.9.30 align
# Auto-fix drift where possible
bunx @lythos/skill-creator@0.9.30 align --fix
```
...
```
Starter (this package) → npm publish → bunx @lythos/skill-creator@0.9.30 ...
