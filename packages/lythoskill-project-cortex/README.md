...
# Maintenance
bunx @lythos/project-cortex@0.9.40 index   # Regenerate INDEX.md
bunx @lythos/project-cortex@0.9.40 probe   # Check status consistency
bunx @lythos/project-cortex@0.9.40 list    # List all tasks and epics
```
...
bunx @lythos/project-cortex@0.9.40 epic "User auth system" --lane main

# Override with reason (recorded in frontmatter)
bunx @lythos/project-cortex@0.9.40 epic "Hotfix login" --lane main --override "security incident"
```

Run `bunx @lythos/project-cortex@0.9.40 probe` to check lane occupancy and catch drift.
...
```
Starter (this package) → npm publish → bunx @lythos/project-cortex@0.9.40 ...
