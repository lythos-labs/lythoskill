...
describe('computePareto', () => {
  it('single participant is always non-dominated', () => {
  ...
  it('clear dominance: run-01 dominates run-02 on all criteria', () => {
    const result = computePareto([
  ...
  it('equal scores: no one dominates', () => {
    const result = computePareto([
  ...
  it('cross dominance: each wins on different criteria', () => {
    const result = computePareto([
  ...
  it('multi-participant: transitive dominance chain', () => {
    const result = computePareto([
  ...
  it('Pareto frontier from playground BDD-research: run-01 dominates run-02', () => {
...
describe('buildComparativePrompt', () => {
  ...
  it('includes Zod schema in output spec', () => {
    const prompt = buildComparativePrompt({
      manifest: manifestFixture,
      verdicts: [],
    })
...
describe('toScoreMatrix', () => {
  it('passes through valid score cells', () => {
...
describe('normalizeComparativeOutput', () => {
  ...
  it('maps participantId to participant_id', () => {
  ...
  it('maps side to participant_id', () => {
    const input: Record<string, unknown> = {
      score_matrix: [
  ...
  it('normalizes weight >1 as percentage', () => {
    const input: Record<string, unknown> = {
      score_matrix: [
  ...
  it('defaults weight to 0.25 when undefined', () => {
    const input: Record<string, unknown> = {
      score_matrix: [
  ...
  it('maps explanation to rationale', () => {
    const input: Record<string, unknown> = {
      score_matrix: [
  ...
  it('normalizes recommendations with role fallback', () => {
    const input: Record<string, unknown> = {
      score_matrix: [],
      key_findings: [],
      recommendations: [
  ...
  it('normalizes recommendations with advice fallback', () => {
    const input: Record<string, unknown> = {
      score_matrix: [],
      key_findings: [],
      recommendations: [
  ...
  it('converts pivot-table format: { participant: { criterion: score } }', () => {
    const input: Record<string, unknown> = {
...
describe('buildComparativePrompt with structured criteria', () => {
  it('injects rubric anchors into prompt', () => {
  ...
  it('falls back to bare format for string criteria', () => {
...
describe('full pipeline: mock LLM output → schema validation', () => {
  it('clean score_matrix passes through ComparativeReport.parse', () => {
    const cleanOutput = {
      score_matrix: [
  ...
  it('messy LLM output with field name variants gets normalized', () => {
