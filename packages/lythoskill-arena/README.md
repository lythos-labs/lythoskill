...
# or use directly
bunx @lythos/skill-arena@0.9.47 <command>
```
...
```
bunx @lythos/skill-arena@0.9.47 scaffold --task "Generate auth flow diagram" \
...
```bash
bunx @lythos/skill-arena@0.9.47 viz runs/arena-<id>/
```
...
```
Starter (this package) → npm publish → bunx @lythos/skill-arena@0.9.47 ...
