...
# or use directly
bunx @lythos/skill-arena@0.10.1 <command>
```
...
```
bunx @lythos/skill-arena@0.10.1 scaffold --task "Generate auth flow diagram" \
...
```bash
bunx @lythos/skill-arena@0.10.1 viz runs/arena-<id>/
```
...
```
Starter (this package) → npm publish → bunx @lythos/skill-arena@0.10.1 ...
