...
# or use directly
bunx @lythos/skill-arena@0.15.1 <command>
```
...
bunx @lythos/skill-arena@0.15.1 vs --config ./arena.toml --player kimi
```
...
```bash
bunx @lythos/skill-arena@0.15.1 vs --config ./arena.toml
bunx @lythos/skill-arena@0.15.1 vs --config ./arena.toml --dry-run
```
...
```bash
bunx @lythos/skill-arena@0.15.1 viz runs/arena-<id>/
```
