...
# or use directly
bunx @lythos/skill-arena@0.17.0 <command>
```
...
bunx @lythos/skill-arena@0.17.0 vs --config ./arena.toml --player kimi
```
...
```bash
bunx @lythos/skill-arena@0.17.0 vs --config ./arena.toml
bunx @lythos/skill-arena@0.17.0 vs --config ./arena.toml --dry-run
```
...
```bash
bunx @lythos/skill-arena@0.17.0 viz runs/arena-<id>/
```
