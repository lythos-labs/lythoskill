...
# or use directly
bunx @lythos/skill-arena@0.9.51 <command>
```
...
```
bunx @lythos/skill-arena@0.9.51 scaffold --task "Generate auth flow diagram" \
...
```bash
bunx @lythos/skill-arena@0.9.51 viz runs/arena-<id>/
```
...
```
Starter (this package) → npm publish → bunx @lythos/skill-arena@0.9.51 ...
