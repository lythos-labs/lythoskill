...
# or use directly
bunx @lythos/skill-arena@0.15.2 <command>
```
...
bunx @lythos/skill-arena@0.15.2 vs --config ./arena.toml --player kimi
```
...
```bash
bunx @lythos/skill-arena@0.15.2 vs --config ./arena.toml
bunx @lythos/skill-arena@0.15.2 vs --config ./arena.toml --dry-run
```
...
```bash
bunx @lythos/skill-arena@0.15.2 viz runs/arena-<id>/
```
