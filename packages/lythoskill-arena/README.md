...
# or use directly
bunx @lythos/skill-arena@0.9.29 <command>
```
...
bunx @lythos/skill-arena@0.9.29 \
...
# Visualize results
bunx @lythos/skill-arena@0.9.29 viz tmp/arena-<id>/
```
...
bunx @lythos/skill-arena@0.9.29 run --config arena.toml --dry-run

# Execute with per-side runs_per_side and statistical aggregation
bunx @lythos/skill-arena@0.9.29 run --config arena.toml
```

### CLI-flag mode (backward compat)

```
bunx @lythos/skill-arena@0.9.29 run \
  --task ./TASK-arena.md \
...
```
bunx @lythos/skill-arena@0.9.29 scaffold --task "..." --skills a,b
```

### Viz

```bash
bunx @lythos/skill-arena@0.9.29 viz runs/arena-<id>/
```
...
```
Starter (this package) → npm publish → bunx @lythos/skill-arena@0.9.29 ...
