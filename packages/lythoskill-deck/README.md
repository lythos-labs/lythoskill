...
bunx @lythos/skill-deck@0.17.11 add vercel-labs/agent-skills

# Or with @skill filter:
bunx @lythos/skill-deck@0.17.11 add mattpocock/skills@tdd

# Or full-qualified locator:
bunx @lythos/skill-deck@0.17.11 add github.com/anthropics/skills/skills/frontend-design
