...
bunx @lythos/skill-deck@0.19.2 add vercel-labs/agent-skills

# Or with @skill filter:
bunx @lythos/skill-deck@0.19.2 add mattpocock/skills@tdd

# Or full-qualified locator:
bunx @lythos/skill-deck@0.19.2 add github.com/anthropics/skills/skills/frontend-design
