...
bunx @lythos/skill-deck@0.15.5 add vercel-labs/agent-skills

# Or with @skill filter:
bunx @lythos/skill-deck@0.15.5 add mattpocock/skills@tdd

# Or full-qualified locator:
bunx @lythos/skill-deck@0.15.5 add github.com/anthropics/skills/skills/frontend-design
