...
export async function addSkill(
  ...
  if (existsSync(deckPath)) {
    ...
    const header = [
      ...
      '# Edit working_set for different platforms:',
      '#   Claude Code:  working_set = ".claude/skills"',
      '#   Codex:        working_set = ".agents/skills"',
      '#   Cursor:       working_set = ".cursor/skills"',
      '#   Kimi:         working_set = ".kimi/skills"',
