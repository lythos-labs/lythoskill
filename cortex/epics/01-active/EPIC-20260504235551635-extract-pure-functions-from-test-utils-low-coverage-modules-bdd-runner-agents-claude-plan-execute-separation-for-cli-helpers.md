...
checklist_skipped_reason: "non-TTY: agent creating epic from fractal architecture analysis"
---
...
> Extract pure functions from test-utils low-coverage modules (bdd-runner, agents/claude): plan/execute separation for CLI helpers
