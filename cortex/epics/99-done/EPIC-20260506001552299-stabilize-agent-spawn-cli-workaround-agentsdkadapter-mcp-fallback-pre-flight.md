...
| 任务 | 状态 | 描述 |
|------|------|------|
| TASK-20260506001644250 | completed | T1: Fix buildClaudeCommand (env, stdin, json, retry) |
| TASK-20260506001644285 | completed | T2: Arena pre-flight (deck link + skill check) |
| TASK-20260506001644316 | completed | T3: Research AgentSdkAdapter prototype |
| TASK-20260506001644356 | completed | T4: AgentSdkAdapter implementation |
| TASK-20260506001644390 | completed | T5: useAgent() routing for claude-sdk (dynamic import in runner.ts L7) |
